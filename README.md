## About
This is the Jekyll code for the RUF JWU website.

## Usage
- ``index.html``: Home page which contains the latest news.
- ``about.md``: About page
- ``meetings.md``: Info page for the time and date of meetings.
- ``photos.md``: Photo gallery, pulls images from ``img/photos`` folder.
- ``_posts``: Folder for the text files that the news pages are generated from.
